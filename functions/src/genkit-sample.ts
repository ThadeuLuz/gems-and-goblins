...
// Cloud Functions for Firebase supports Genkit natively. The onCallGenkit function creates a
// callable function from a Genkit action. It automatically implements streaming if your flow does.
